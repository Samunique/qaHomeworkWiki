...
//FILL OUT LOCATORS CONSTRUCTOR AND METHODS IN ORDER TO PASS THE TEST
  class employeePage {
      ...
      employeeList: By = By.css('.listContainer');
  ...
  describe("Employee Manger Test", () => {
      ...
      test("adding an employee", async () => {
          ...
          await driver.findElement(emPage.newEmployees).click()
          await driver.findElement(emPage.nameInput).click()
          await driver.findElement(emPage.nameInput).clear()
          await driver.findElement(emPage.nameInput).sendKeys("Sam Samson")
          ...
          await driver.findElement(emPage.titleInput).sendKeys("the man")
        })
  })